	        ...
	        <div class="panel-body">
                	...
                	<div class="row">
                     <div class="col-lg-10">
                     	...
                     	<h4><strong>Knjiga:</strong> {{$knjiga->title}}</h4>
                     	<p>Žanr: {{$knjiga->category}}</p>
   		...
   		<div>
			...
			<div class="row">
         		<div class="col-lg-8">
   					...
   					<form method="POST" action="{{route('update.knjiga', ['id' => $knjiga->id])}}" role="form" id="details" enctype="multipart/form-data">
