...
<div class="row">
	        ...
	        <div class="panel-body">
                	...
                	<div class="row">
                     <div class="col-lg-10">
                     	...
                     	<h4><strong>Strip:</strong> {{$strip->title}}</h4>
                     	<p>Žanr: {{$strip->category}}</p>
   		...
   		<div>
			...
			<div class="row">
         		<div class="col-lg-8">
   					...
   					<form method="POST" action="{{route('update.strip', ['id' => $strip->id])}}" role="form" id="details" enctype="multipart/form-data">
	...
	<div class="form-group">
		...
		<!-- Tiraz -->
	<div class="form-group">
		<input type="number" min="" max="" class="form-control col-md-6" name="edition" form="details">
