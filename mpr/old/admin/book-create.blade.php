    ...
    <div class="col-lg-12">
     ...
     <hr>
        ...
        <ol class="breadcrumb" style="text-align:center;">
            ...
            <li class="active">
                <i class="fa fa-plus-circle"></i> Nova knjiga
            </li>
        </ol>
    </div>
    <!-- /.col-lg-12 -->
...
<div class="row">
    <div class="col-lg-8 col-lg-offset-1">
	    ...
	    <div class="panel panel-primary">
	        <div class="panel-heading"><strong>Dodaj novu knjigu</strong></div>

	        <div class="panel-body">
	             <div class="col-lg-8">
					 
<form method="POST" action="{{route('store.knjiga')}}" role="form" id="create">
	
	<br>
  <div class="form-group">
    <input type="text" class="form-control" id="title" name="title" form="create">
    <p class="help-block"><em><small>naziv knige</small></em></p>
  </div>
  ...
  <div class="form-group">
   ...
   <div class="form-group">
		<select name="category" class="form-control col-md-8" form="create">
			<option value="" selected>žanr knjige...</option>
	...
	<button type="reset" class="btn btn-danger">Reset</button>    	
						...
						<h5><a href="{{route('admin.index.knjiga')}}"><i class="fa fa-arrow-circle-right"></i>&nbsp;&nbsp;pregled knjiga</a></h5>				
